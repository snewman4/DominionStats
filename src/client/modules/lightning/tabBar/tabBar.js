...
const labelOverflowMore = getLabel('lightning_LightningTabs_overflowMore');
const labelOverflowMoreAlternativeText = getLabel('lightning_LightningTabs_overflowMoreAlternativeText');
const labelOverflowMoreTitle = getLabel('lightning_LightningTabs_overflowMoreTitle');
const labelErrorStateAlternativeText = getLabel('lightning_LightningTabs_errorStateAlternativeText');
