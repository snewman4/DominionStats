...
describe('lightning-button-menu', () => {
...
describe('lightning-button-menu-label', () => {
...
describe('lightning-button-menu-onclose', () => {
...
describe('lightning-button-menu-icon-name-attr', () => {
    const getIconCount = (buttonMenu) => {
        return shadowQuerySelectorAll(buttonMenu, 'lightning-primitive-icon').length;
    };
...
describe('is-loading attribute', () => {
    it('if set to false, or omitted, spinner should be hidden when menu is opened', () => {
        ...
        return Promise.resolve().then(() => {
            const spinnerEl = shadowQuerySelector(buttonMenu, 'lightning-spinner');
