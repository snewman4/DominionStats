...
const labelAriaSelectedOptions = getLabel('lightning_LightningCombobox_ariaSelectedOptions');
const labelDeselectOptionKeyboard = getLabel('lightning_LightningCombobox_deselectOptionKeyboard');
const labelLoadingText = getLabel('lightning_LightningCombobox_loadingText');
const labelPillCloseButtonAlternativeText = getLabel('lightning_LightningCombobox_pillCloseButtonAlternativeText');
