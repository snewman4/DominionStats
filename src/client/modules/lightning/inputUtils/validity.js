...
import { getLabel } from 'lightning/labels';
const labelBadInput = getLabel('lightning_LightningErrorMessage_validityBadInput');
const labelPatternMismatch = getLabel('lightning_LightningErrorMessage_validityPatternMismatch');
const labelRangeOverflow = getLabel('lightning_LightningErrorMessage_validityRangeOverflow');
const labelRangeUnderflow = getLabel('lightning_LightningErrorMessage_validityRangeUnderflow');
const labelStepMismatch = getLabel('lightning_LightningErrorMessage_validityStepMismatch');
const labelTooLong = getLabel('lightning_LightningErrorMessage_validityTooLong');
const labelTooShort = getLabel('lightning_LightningErrorMessage_validityTooShort');
const labelTypeMismatch = getLabel('lightning_LightningErrorMessage_validityTypeMismatch');
const labelValueMissing = getLabel('lightning_LightningErrorMessage_validityValueMissing');
