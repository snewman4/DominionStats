...
function createAccordion(props = {}) {
    const accordion = createElement('lightning-accordion-test', {
        is: AccordionTest
    });
...
describe('lightning-accordion using slots', () => {
    ...
    it('should allow lwc:ifs', () => {
        ...
        return Promise.resolve().then(() => {
            ...
            expect(qsa('lightning-accordion-section')).toHaveLength(2);
            elem.isBVisible = true;

            return Promise.resolve().then(() => {
                expect(qsa('lightning-accordion-section')).toHaveLength(3);
            });
        });
    });
...
describe('lightning-accordion that allows multiple sections open', () => {
    ...
    it('should render all sections close by default', () => {
        ...
        return Promise.resolve().then(() => {
            expect(
                qs('lightning-accordion-section.section-a', '.slds-is-open')
            ).toBeNull();
            expect(
                qs('lightning-accordion-section.section-b', '.slds-is-open')
            ).toBeNull();
            expect(
                qs('lightning-accordion-section.section-c', '.slds-is-open')
            ).toBeNull();
        });
    });
    ...
    it('should collapse sections when selected', () => {
        ...
        return Promise.resolve().then(() => {
            ...
            qs('lightning-accordion-section.section-c', 'button').click();
    ...
    it('should triggers sectiontoggle event when multiple', () => {
        ...
        return Promise.resolve().then(() => {
            ...
            qs('lightning-accordion-section.section-a', 'button').click();
